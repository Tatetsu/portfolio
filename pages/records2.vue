<template>
  ...
  <div class="select">
    <div class="menu">
      <h2>脚の筋トレ</h2>
    <ul class="flex">
      <li class="menu_btn mr-8"><button class="btn rounded-sm border-solid">スクワット</button></li>
      <li class="menu_btn mr-8"><button class="btn rounded-sm border-solid">レッグエクステンション</button></li>
      <li class="menu_btn mr-8"><button class="btn rounded-sm border-solid">レッグカール</button></li>
      <li class="menu_btn mr-8"><button class="btn rounded-sm border-solid">ブルガリアンスクワット</button></li>
    </ul>
    </div>
  </div>
  </section>
